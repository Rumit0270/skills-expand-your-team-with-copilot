...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'unspecified' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty.lower() == "unspecified":
            # "unspecified" means activities without a difficulty field
